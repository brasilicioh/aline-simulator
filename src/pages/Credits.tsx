    ...
    <div className="bg-gray-800 flex flex-col gap-3 items-center min-h-screen">
      ...
      <div className="grid grid-cols-3 gap-5">
        <div className="flex flex-col relative justify-center items-center">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9ZNVPEEQy9ha11CyKqc2vexUSTwDzupm6dk64hDQIBFEf0QyHwgcLOGRI&s=10" alt="" 
            className="w-60 h-60"
          />
          <p className="text-center w-60 absolute bottom-0 bg-black text-white">Nome do Tanque: Hetzer</p>
        </div>
        <div className="flex flex-col relative justify-center items-center">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9ZNVPEEQy9ha11CyKqc2vexUSTwDzupm6dk64hDQIBFEf0QyHwgcLOGRI&s=10" alt="" 
            className="w-60 h-60"
